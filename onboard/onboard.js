...
const northVanObj = new City("North Vancouver", [-123.125820, 49.351542]);
const richmondObj = new City("Richmond", [-123.108487, 49.173966]);
const surreyObj = new City("Surrey", [-122.841305, 49.159780]);
  ...
  navigator.geolocation.getCurrentPosition(
      (position) => {
          ...
          async function tr(){
                  ...
                  // }
                  document.getElementById("location-1").innerHTML = `Location: ${cityArray[0].name}<br>Distance: ${Math.round((cityArray[0].distance / 10)) / 100} kilo mtrs`
                  document.getElementById("location-2").innerHTML = `Location: ${cityArray[1].name}<br>Distance: ${Math.round((cityArray[1].distance / 10)) / 100} kilo mtrs`
                  document.getElementById("location-3").innerHTML = `Location: ${cityArray[2].name}<br>Distance: ${Math.round((cityArray[2].distance / 10)) / 100} kilo mtrs`
                  document.getElementById("location-4").innerHTML = `Location: ${cityArray[3].name}<br>Distance: ${Math.round((cityArray[3].distance / 10)) / 100} kilo mtrs`
                  document.getElementById("location-5").innerHTML = `Location: ${cityArray[4].name}<br>Distance: ${Math.round((cityArray[4].distance / 10)) / 100} kilo mtrs`
          }
          ...
          var northVan = new tt.Marker({ element: nvEl }).setLngLat(northVanObj.geoLoc).addTo(map);
          ...
          var richmond = new tt.Marker({ element: rchEl }).setLngLat(richmondObj.geoLoc).addTo(map);
          ...
          var surrey = new tt.Marker({ element: surrEl }).setLngLat(surreyObj.geoLoc).addTo(map);
          ...
          var abbotsford = new tt.Marker({ element: abtfEl }).setLngLat(abbotsfordObj.geoLoc).addTo(map);
          ...
          var coquitlam = new tt.Marker({ element: coqEl }).setLngLat(coquitlamObj.geoLoc).addTo(map);
