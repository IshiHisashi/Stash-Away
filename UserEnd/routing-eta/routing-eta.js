...
const strageLoc = [
  [-123.12582, 49.351542],
  [-123.108487, 49.173966],
  [-122.841305, 49.15978],
  [-122.323466, 49.065087],
  [-122.776836, 49.283485],
  [-121.954941, 49.150314],
  [-123.422233, 48.523145],
  [-119.455072, 49.869284],
];
  ...
  navigator.geolocation.getCurrentPosition(
    (position) => {
      ...
      var northVan = new tt.Marker({ element: nvEl })
        .setLngLat([strageLoc[0][0], strageLoc[0][1]])
        .addTo(map);
      ...
      var richmond = new tt.Marker({ element: rchEl })
        .setLngLat([strageLoc[1][0], strageLoc[1][1]])
        .addTo(map);
      ...
      var surrey = new tt.Marker()
        .setLngLat([strageLoc[2][0], strageLoc[2][1]])
        .addTo(map);
      var abbotsford = new tt.Marker()
        .setLngLat([strageLoc[3][0], strageLoc[3][1]])
        .addTo(map);
      var coquitlam = new tt.Marker()
        .setLngLat([strageLoc[4][0], strageLoc[4][1]])
        .addTo(map);
      var chilliwack = new tt.Marker()
        .setLngLat([strageLoc[5][0], strageLoc[5][1]])
        .addTo(map);
      var victoria = new tt.Marker()
        .setLngLat([strageLoc[6][0], strageLoc[6][1]])
        .addTo(map);
      var kelowna = new tt.Marker()
        .setLngLat([strageLoc[7][0], strageLoc[7][1]])
        .addTo(map);
      ...
      function route(map) {
        tt.services
          .calculateRoute({
            key: tomtomMapsApiKey, // Get on for free at developer.tomtom.com
            routeType: "shortest",
            locations: waypoints,
          })
          .then((result) => {
